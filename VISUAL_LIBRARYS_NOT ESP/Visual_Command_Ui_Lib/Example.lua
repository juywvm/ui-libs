...
local Library = loadstring(game:HttpGet('https://raw.githubusercontent.com/juywvm/ui-libs/main/VISUAL_LIBRARYS_NOT%20ESP/Visual_Command_Ui_Lib/Source.lua', true))()
