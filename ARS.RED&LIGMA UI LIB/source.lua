--original loadstring from:   https://wednesday.wtf/ars/library.lua    (this is backup, i dont steal credits or sum)
...
--[[   Message from Batus (juywvm)   ]]-- pictures (png)  are obfuscated with base64, if you want to see deobfuscate & see it, use this website:     base64.guru/converter/decode/image/png 
local assets = {
